...
此文件位于 agent 目录下，与 emotion_analysis_skill.py 在同一目录中
"""
import base64
import os
from agent.emotion_analysis_skill import EmotionAnalysisSkill, EmotionAnalysisMCP, analyze_emotion, clean_multimodal_text
...
def main():
    ...
    print("此文件位于 agent 目录下，与 emotion_analysis_skill.py 在同一目录中")
